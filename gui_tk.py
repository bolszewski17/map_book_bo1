...
button_pokaz_szczegoly=Button(ramka_lista_uzytkownikow, text='Pokaż szczególy', command=pokaz_szczegoly_uzytkownika)
...
label_opis_obiektu=Label(ramka_szczegoly_obiektu, text='Szczegółu obiektu:')
